...
function displayArea(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartoona += `
                    <div class="col-md-3">
          <div onclick="getAreaMeals('${arr[i].strArea}')" class="country rounded-2 text-center">
...
function displayMeals(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartoona += `
            <div class="col-md-3">
          <div onclick="displayMealsData('${arr[i].idMeal}')" class="img-frame rounded-2 overflow-hidden position-relative">
